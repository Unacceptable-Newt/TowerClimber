 ...
 */
 ...
 Enemy enemy = new Enemy("null", 0, 0, 0, new Position(5, 4));
 

 @Test
 public void testNearby1 (){
    Assertions.assertFalse(org.example.gameLogic.Approach.isNearby(player1,enemy));
 }
 @Test
 public void testNearby2 (){
    Assertions.assertTrue(org.example.gameLogic.Approach.isNearby(player2,enemy));
 }
 @Test
 public void testNearby3 (){  
    Assertions.assertTrue(org.example.gameLogic.Approach.isNearby(player3,enemy));
 }
